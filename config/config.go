...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		DbName:            getEnvStr("DB_NAME", "TEAMDEV"),
		...
		SupportGroup:      getEnvStr("SUPPORT_GROUP", "https://t.me/TEAM_X_OG"),
		SupportChannel:    getEnvStr("SUPPORT_CHANNEL", "https://t.me/CRIMEZONE_UPDATE"),
